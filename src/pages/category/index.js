...
function CategoryPage(props) {
    ...
    const getListCateProducts=()=>{
        if(cate.cateName=='all'){
            ...
            axios.get("https://fakestoreapi.com/products/category/"+cate.cateName)
                .then(res=>{
                    if(Array.isArray(res.data)){
                        setListCateProducts(res.data);
                    }
            ...
            <div className="container">
                <div className="category">
                    ...
                    <div className="category-content">
                        <input id={'checked-filters'} className={'check-filters'} type="checkbox" hidden={true}/>
                        <div className="filters" ref={filters}>
                            <div className="filter">
                                <div className="filter-title">
                                    <span>Filters</span>
                                    <label htmlFor='checked-filters' onClick={handleScrollToTop}>
                                        <img src={images.icCloseSolid} className="ic-close-filter-mobile" alt=""/>
                                    </label>
                                ...
                                <div className="filter-color">
                                    {
                                        cols.map((item,index)=>{
                                            return (
                                                <div className="color-picker" key={index} onClick={()=>{setColor(index)}} style={{backgroundColor: item}}>{color==index?'X':''}</div>
                                            );
                                        })
                                    }
                                </div>
                                ...
                                <div className="filter-type">
                                    {
                                        listCate.map((item,index)=>{
                                            return (
                                                <div className="type-product" key={index} onClick={()=>{navigate('/category/'+item)}}>
                                                    <span>{item}</span>
                                                    <img src={images.icDropRight} alt=""/>
                                                </div>
                                            );
                            ...
                            <div className="btn-apply">
                                <label htmlFor={"checked-filters"} onClick={handleScrollToTop}>Apply Filter</label>
                            </div>
                        ...
                        <div className="cate-products">
                            <div className="product-style">
                                ...
                                <label htmlFor={'checked-filters'} className="ic-open-filters-mobile">
                        ...
                        <label htmlFor="checked-filters" className={'overlay-category'} onClick={handleScrollToTop}></label>
                    </div>
                </div>
            </div>
            <Footer/>
